...
class AccreditationsController extends Controller
{
    ...
    {
        $data = Accreditations::all();
        return view('admin.accreditations.index', compact("data"));
    }
...
{
    $data = Accreditations::findOrFail($id);
    return view('admin.accreditations.edit', compact('data'));
}
...
public function update(Request $request, $id)
{
    ...
    $about = Accreditations::findOrFail($id);
