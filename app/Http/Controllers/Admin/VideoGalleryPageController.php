...
use App\Models\VideoGalleryPage;
...
{
  $data = VideoGalleryPage::findOrFail($id);
  return view('admin.video_gallery_page.edit', compact('data'));
}
...
public function update(Request $request, $id)
{
  ...
  $about = VideoGalleryPage::findOrFail($id);


  if ($request->hasFile('image')) {
  
      if ($about->image) {
          $oldFilePath = public_path('uploads/video_gallery_page/' . $about->image);
      ...
      $data['image'] = $image;
      $request->image->move(public_path('uploads/video_gallery_page/'), $image);
  }
