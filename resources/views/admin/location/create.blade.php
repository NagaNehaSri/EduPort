                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="vision" class="form-control @error('vision') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image2">Front Image * :</label>
                                            <input type="file" class="dropify @error('image2') is-invalid @enderror" name="image2"
                                                   id="image2" accept="image/jpg, image/jpeg, image/png">
                                            @error('image2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
