                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Vison Mission </li>
                        </ol>
                    </div>
                    @section('page_title')
                    Vison Mission 
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Vison Mission </h4>
                            </div>
                            <!-- <div class="col-md-6">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
                                            @if ($data->image != '')
                                            <a href="{{ asset('uploads') }}/vision_mission_spec/{{ $data->image }}"
                                                target="_blank">
                                                <img class="avatar-lg"
                                                    src="{{ asset('uploads') }}/vision_mission_spec/{{ $data->image }}"
                                                    alt="{{ $data->title }}">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('vision_mission.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('vision_mission_spec.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form> -->
                                        </td>
