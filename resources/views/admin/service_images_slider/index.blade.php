                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Service Slider Image</li>
                            </ol>
                        </div>
                    @section('page_title')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Service Slider Image</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('service_images_slider.create',['service_id' => $service_id]) }}">
                                    <button class="btn btn-success btn-sm float-right ml-2"><i class="fas fa-plus"></i>
                                        Add Service Slider Image
                                    </button>
                                </a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                            @if ($data->images != '')
                                                    <a href="{{ asset('uploads') }}/service_images_slider/{{ $data->images }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/service_images_slider/{{ $data->images }}"
                                                            alt="">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('service_images_slider.edit', $data->id) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('service_images_slider.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
