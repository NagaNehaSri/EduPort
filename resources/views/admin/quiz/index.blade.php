...
@section('content')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('chapters.index') }}">Chapter</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('quiz.create',['chapter_id' => $chapter_id]) }}">
    ...
    @if(!empty($data->question_image))
        <img src="{{ asset('uploads/quiz/' . $data->question_image) }}" alt="Quiz Image" width="100">
    @else
        <img src="{{ asset('uploads/quiz/default.png') }}" alt="No Image" width="100">
    @endif
</td>
                                            ...
                                            <td>
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('quiz.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
