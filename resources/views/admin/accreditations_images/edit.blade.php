                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Accreditations Images</li>
                        </ol>
                    </div>
                    @section('page_title')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Accreditations Images</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('accreditations_images.update', [$data->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="dropify @error('image') is-invalid @enderror" name="image"
                                            ...
                                            data-default-file="{{ asset('uploads/accreditations_images/' . $data->image) }}">
                                        @error('image')
