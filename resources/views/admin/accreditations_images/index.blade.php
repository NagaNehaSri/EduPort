                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('accreditations_images.create', ['accreditations_id' => $accreditations_id]) }}">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($data->image))
                                            <a href="{{ asset('uploads/image/' . $data->image) }}" target="_blank">
                                                <img class="avatar-lg" src="{{ asset('uploads/accreditations_images/' . $data->image) }}" alt="Project Image">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('accreditations_images.edit', $data->id) }}" class="btn btn-primary waves-effect waves-light btn-xs">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button data-value="{{ $data->id }}" class="btn btn-danger waves-effect waves-light btn-xs cdelete"><i class="fas fa-trash"></i></button>
                                            <form id="deleteform{{ $data->id }}" method="post" action="{{ route('accreditations_images.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
