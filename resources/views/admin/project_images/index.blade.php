                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('project_images.create', ['project_id' => $project_id]) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!empty($data->project_image))
                                                        <a href="{{ asset('uploads/project_image/' . $data->project_image) }}" target="_blank">
                                                            <img class="avatar-lg" src="{{ asset('uploads/project_image/' . $data->project_image) }}" alt="Project Image">
                                                        </a>
                                                    @else
                                                ...
                                                <td>
                                                    <a href="{{ route('project_images.edit', $data->id) }}" class="btn btn-primary waves-effect waves-light btn-xs">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button data-value="{{ $data->id }}" class="btn btn-danger waves-effect waves-light btn-xs cdelete"><i class="fas fa-trash"></i></button>
                                                    <form id="deleteform{{ $data->id }}" method="post" action="{{ route('project_images.destroy', [$data->id]) }}">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                                    </form>
                                                </td>
