                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">Student Serivices</li>
                            <li class="breadcrumb-item active">Edit Student Serivices</li>
                        </ol>
                    </div>
                    @section('page_title')
                    Student Serivices
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Student Serivices</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('student_services.update', [$data->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="description_3" class="form-control sun-editor @error('description_3') is-invalid @enderror" name="description_3">{{ $data->description_3 }}</textarea>
                                    @error('description_3')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="image" class="dropify @error('image') is-invalid @enderror" name="image" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/student_services/' . $data->image) }}" />
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="image_2" class="dropify @error('image_2') is-invalid @enderror" name="image_2" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/student_services/' . $data->image_2) }}" />
                                    @error('image_2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
