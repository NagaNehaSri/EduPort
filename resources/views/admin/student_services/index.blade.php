                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($data->image != '')
                                                    <a href="{{ asset('uploads') }}/student_services/{{$data->image  }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/student_services/{{ $data->image }}"
                                                            alt="{{ $data->heading }}">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                @if ($data->image_2 != '')
                                                    <a href="{{ asset('uploads') }}/student_services/{{$data->image_2  }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/student_services/{{ $data->image_2 }}"
                                                            alt="{{ $data->heading }}">
                                                    </a>
                                                @else
                                                    <span class="badge badge-warning">No Image</span>
                                            ...
                                            <td>
                                                <a href="{{ route('student_services.edit', [$data->id]) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('student_services.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
