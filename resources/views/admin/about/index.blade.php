                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Homepage About Image</th>
                                        <th>Aboutpage About Image</th>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($data->image != '')
                                                    <a href="{{ asset('uploads') }}/banners/{{ $homepage_image  }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/banners/{{ $data->$homepage_image }}"
                                                            alt="{{ $data->heading }}">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                @if ($data->image != '')
                                                    <a href="{{ asset('uploads') }}/banners/{{ $aboutpage_image  }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/banners/{{ $data->$aboutpage_image }}"
                                                            alt="{{ $data->heading }}">
                                                    </a>
                                                @else
                                                    <span class="badge badge-warning">No About Image</span>
                                            ...
                                            <td>
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('about.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
