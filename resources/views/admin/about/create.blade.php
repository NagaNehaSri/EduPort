                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="post" action="{{ route('banner.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('heading_2') is-invalid @enderror"
                                                   name="heading_2" id="heading_2" value="{{ old('heading_2') }}"
                                                   autocomplete="off">
                                            @error('heading_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="bannersupportimage">Banner Support Image  * :</label>
                                            <input type="file" class="dropify @error('bannersupportimage') is-invalid @enderror" name="bannersupportimage"
                                                   id="bannersupportimage" accept="image/jpg, image/jpeg, image/png">
                                            @error('bannersupportimage')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                            <div class="text-muted mt-1"><kbd>* Image size 193.883 x 159.517 pixels</kbd></div>
                                        </div>
                                    </div>
