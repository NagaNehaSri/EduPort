                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="title" value="{{ $data->title }}" autocomplete="off">
                                            @error('title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="og_title" id="og_title" value="{{ $data->og_title }}"
                                                autocomplete="off">
                                            @error('og_title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $data->twitter_title }}" autocomplete="off">
                                            @error('twitter_title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="og_description" id="og_description" class="form-control">{{ $data->og_description }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="twitter_description" id="twitter_description" class="form-control">{{ $data->twitter_description }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="og_image"
                                                class="dropify @error('og_image') is-invalid @enderror" name="og_image"
                                                data-height="150"
                                                data-default-file="{{ asset('site_settings') . '/' . $data->og_image }}" />
                                            @error('og_image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="twitter_image"
                                                class="dropify @error('twitter_image') is-invalid @enderror" name="twitter_image"
                                                data-height="150"
                                                data-default-file="{{ asset('site_settings') . '/' . $data->twitter_image }}" />
                                            @error('twitter_image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
