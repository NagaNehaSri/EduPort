                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Image CMS</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Image CMS
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($data->image != '')
                                                    <a href="{{ asset('uploads') }}/cms/{{ $data->image }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/cms/{{ $data->image }}"
                                                            alt="{{ $data->heading }}">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('image_cms.edit', [$data->id]) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('image_cms.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
