                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Our Working Process</li>
                        </ol>
                    </div>
                    @section('page_title')
                    Our Working Process
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('what_we_provide.create') }}">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
                                            @if ($data->image != '')
                                            <a href="{{ asset('uploads') }}/what_we_Provide/{{ $data->image }}"
                                                target="_blank">
                                                <img class="avatar-lg"
                                                    src="{{ asset('uploads') }}/what_we_Provide/{{ $data->image }}"
                                                    alt="{{ $data->title }}">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('what_we_provide.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('what_we_provide.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
