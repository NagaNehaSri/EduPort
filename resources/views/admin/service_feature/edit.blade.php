                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('service_feature.index') }}">Service Feature</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Service Feature</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('service_feature.update', [$data->id]) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            ...
                                            name="image" id="image"
                                            accept="image/jpg, image/jpeg, image/png, image/webp" data-default-file="{{ asset('uploads') }}/service_feature/{{ $data->image }}">
                                        @error('image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
