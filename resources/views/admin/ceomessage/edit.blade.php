            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form id="form" method="post" action="{{ route('ceomessage.update', [$data->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="image"
                                            class="dropify @error('image') is-invalid @enderror" name="image"
                                            accept="image/jpg, image/jpeg, image/png, image/webp, image/svg+xml"
                                            data-height="150"
                                            data-default-file="{{ asset('uploads/about/' . $data->image) }}" />
                                        @error('image')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tag" class="control-label">Quote*</label>
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="designation"
                                            class="form-control mini-suneditor @error('designation') is-invalid @enderror"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="image_2"
                                            class="dropify @error('image_2') is-invalid @enderror" name="image_2"
                                            accept="image/jpg, image/jpeg, image/png, image/webp, image/svg+xml"
                                            data-height="150"
                                            data-default-file="{{ asset('uploads/about/' . $data->image_2) }}" />
                                        @error('image_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description_2" class="form-control sun-editor @error('description_2') is-invalid @enderror"
                                            name="description_2">{{ $data->description_2 }}</textarea>
                                        @error('description_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description_3" class="form-control sun-editor @error('description_3') is-invalid @enderror"
                                            name="description_3">{{ $data->description_3 }}</textarea>
                                        @error('description_3')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
