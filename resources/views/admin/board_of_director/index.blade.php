            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Board of Director</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('board_of_director.create') }}">
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($data->image != '')
                                                    <a href="{{ asset('uploads') }}/board_of_directors/{{ $data->image }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/board_of_directors/{{ $data->image }}"
                                                            alt="{{ $data->heading }}">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('board_of_director.edit', [$data->id]) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('board_of_director.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
