                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('board_of_director.index') }}">Board of
                                        Director</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Add Board of Director</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('board_of_director.store') }}"
