                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('count.index') }}">Count</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Add Count</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('count.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('icon_name') is-invalid @enderror"
                                                   name="icon_name" id="icon_name" value="{{ old('icon_name') }}"
                                                   autocomplete="off">
                                            @error('icon_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <!-- <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            <div class="text-muted mt-1"><kbd>* Image size 38 x 38 pixels</kbd></div>
                                        </div>
                                    </div> -->
