            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form id="form" method="post" action="{{ route('test_exams.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <!-- <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tag" class="form-control @error('tag') is-invalid @enderror" name="tag" value="{{ old('tag') }}" />
                                        @error('tag')
