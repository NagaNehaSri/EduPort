                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">Test Exams</li>
                            <li class="breadcrumb-item active">Edit Test Exams</li>
                        </ol>
                    </div>
                    @section('page_title')
                    Test Exams
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Test Exams</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('test_exams.update', [$data->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="image" class="dropify @error('image') is-invalid @enderror" name="image" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/test_exams/' . $data->image) }}" />
                                        @error('image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="image_2" class="dropify @error('image_2') is-invalid @enderror" name="image_2" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/test_exams/' . $data->image_2) }}" />
                                        @error('image_2')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
