                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Banner Feature Text</li>
                            </ol>
                        </div>
                        @section('page_title')
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Add Banner Feature Text</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('banner_feature.store') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bannerfeaturetext') is-invalid @enderror"
                                                   name="bannerfeaturetext" id="bannerfeaturetext" value="{{ old('bannerfeaturetext') }}"
                                                   autocomplete="off">
