                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form id="form" method="post" action="{{ route('team.update', [$data->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify @error('profile_image') is-invalid @enderror" name="profile_image"
                                                   id="profile_image" accept="image/jpg, image/jpeg, image/png,image/webp" data-default-file="{{ asset('uploads/team/'.$data->profile_image) }}">
                                            @error('profile_image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                            <span class="font-13 text-muted">* Image size <code>width : 354px</code> x <code>height : 424px</code></span>
                                        </div>
                                    </div>
