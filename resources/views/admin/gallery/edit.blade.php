                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-right mb-2">
                            <a href="{{route('gallery_images.index')}}" class="btn btn-dark waves-effect waves-light btn-xs">
                        ...
                        <hr>
                        <form id="form" method="post" action="{{ route('gallery.update', [$data->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="image" class="dropify @error('image') is-invalid @enderror" name="image" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/gallery/' . $data->image) }}" />
                                            @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
