                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Service Name</th>
                                        <!-- <th>Add Service Image</th> -->
                                        <th>Add Service Features</th>
                                        <th>Modified At</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><a href="{{ route('service_images_slider.index', ['service_id' => $data->id]) }}" class="btn btn-dark waves-effect waves-light btn-xs">
                                                <i class="fas fa-plus"></i> Add Service Images
                                            </a> </td> -->
                                        <td><a href="{{route('service_feature.index',['service_id' => $data->id])}}" class="btn btn-dark waves-effect waves-light btn-xs">
                                                <i class="fas fa-plus"></i> Add Service Features
                                                </a> </td>
                                        ...
                                        <td>
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('service.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
