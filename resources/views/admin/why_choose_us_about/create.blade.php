                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('why_choose_us_about.index') }}">Why Learn With
                                        Us</a></li>
                                <li class="breadcrumb-item active">Add Why Learn With Us</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Add Why Learn With Us
                    @endsection
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Add Why Learn With Us</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('why_choose_us_about.store') }}"
