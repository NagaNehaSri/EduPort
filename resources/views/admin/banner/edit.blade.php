            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form id="form" method="post" action="{{ route('banner.update', [$data->id]) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="priority" value="{{ $data->priority }}" autocomplete="off">
                                        @error('priority')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                {{-- <!-- <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify @error('background_image') is-invalid @enderror" name="background_image"
                                                   id="background_image" accept="image/jpg, image/jpeg, image/png" data-default-file="{{ asset('uploads/banners/'.$data->background_image) }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="dropify @error('image') is-invalid @enderror"
                                            ...
                                            data-default-file="{{ asset('uploads/banners/' . $data->image) }}">
                                        @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
