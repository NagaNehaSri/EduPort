                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Chapters Content</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Chapters Content
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('chapter_content.create',['chapter_id' => $chapter_id]) }}">
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('chapter_content.edit', $data->id) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('chapter_content.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
