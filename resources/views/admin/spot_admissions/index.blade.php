                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Spot Admissions</li>
                            </ol>
                        </div>
                    @section('page_title')
                    Spot Admissions
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Spot Admissions</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('spot_admissions.create') }}">
                                    <button class="btn btn-success btn-sm float-right ml-2"><i class="fas fa-plus"></i>
                                        Create Spot Admissions
                                    </button>
                                </a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <!-- <td>
                                            <a href="{{route('blog_slider_image.index', ['blog_id' => $data->id])}}" class="btn btn-dark waves-effect waves-light btn-xs">
                                                <i class="fas fa-plus"></i> Add Slider Images
                                            </a>
                                        </td> -->
                                            <td>{{ \Carbon\Carbon::parse($data->updated_at)->format('d M Y h:i A') }}
                                            </td>
                                            <td>
                                                <a href="{{ route('spot_admissions.edit', [$data->id]) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('spot_admissions.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
