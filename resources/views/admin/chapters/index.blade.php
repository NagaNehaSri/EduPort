                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>view Image</th>
                                        <!-- <th>Add Chapters Image</th> -->
                                        <th>Add Chapters Classes</th>
                                        <th>Modified At</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $data->chapters_name }}</td>
                                  
                                        <td>{{ $data->priority }}</td>
                                        <td>
                                            @if (!empty($data->thumbnail_image))
                                            <a href="{{ asset('uploads/chapters/' . $data->thumbnail_image) }}" target="_blank">
                                                <img class="avatar-lg" src="{{ asset('uploads/chapters/' . $data->thumbnail_image) }}" alt="Project Image">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            @if (!empty($data->view_image))
                                            <a href="{{ asset('uploads/chapters/' . $data->view_image) }}" target="_blank">
                                                <img class="avatar-lg" src="{{ asset('uploads/chapters/' . $data->view_image) }}" alt="Project Image">
                                            </a>
                                            @else
                                            <span class="badge badge-warning">No Image</span>
                                            @endif
                                        </td>
                                      <td><a href="{{ route('chapter_content.index', ['chapter_id' => $data->id]) }}" class="btn btn-dark waves-effect waves-light btn-xs">
                                                <i class="fas fa-plus"></i> Add Chapter Content
                                            </a> </td> 
                                        <td><a href="{{route('quiz.index',['chapter_id' => $data->id])}}" class="btn btn-dark waves-effect waves-light btn-xs">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('chapters.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('chapters.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
