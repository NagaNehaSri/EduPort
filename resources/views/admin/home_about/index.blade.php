                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($data->image != '')
                                            <a href="{{ asset('uploads') }}/banners/{{ $data->image }}"
                                                target="_blank">
                                                <img class="avatar-lg"
                                                    src="{{ asset('uploads') }}/banners/{{ $data->image }}"
                                                    alt="{{ $data->heading }}">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{route('home_about_images_.index', ['home_about_id' => $data->id])}}" class="btn btn-dark waves-effect waves-light btn-xs">
                                                <i class="fas fa-plus"></i> Add Home About Slider Images
                                            </a>
                                            </td>
