                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('resort_section.index') }}">Resort Sections</a></li>
                                <li class="breadcrumb-item active">Edit Resort Sections</li>
                            </ol>
                        </div>
                        @section('page_title')
                            Resort Sections
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Resort Sections</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('resort_section.update', [$data->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify @error('image') is-invalid @enderror" name="image"
                                                   id="image" accept="image/jpg, image/jpeg, image/png,image/webp" data-default-file="{{ asset('uploads/resort_section/'.$data->image) }}">
                                            @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
