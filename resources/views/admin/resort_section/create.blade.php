                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Resort Sections</li>
                            </ol>
                        </div>
                        @section('page_title')
                            Add Resort Sections
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Add Resort Sections</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('resort_section.store') }}"
