                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
                                            @if ($data->image != '')
                                            <a href="{{ asset('uploads') }}/succes_stories_spec/{{ $data->image }}"
                                                target="_blank">
                                                <img class="avatar-lg"
                                                    src="{{ asset('uploads') }}/succes_stories_specc/{{ $data->image }}"
                                                    alt="{{ $data->title }}">
                                            </a>
                                            @else
                                            <span class="badge badge-warning">No About Image</span>
                                            @endif
                                        </td> -->
                                        ...
                                        <td>
                                            <a href="{{ route('succes_stories_spec.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('succes_stories_spec.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
