                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('about.index') }}">About Slider Image</a></li>
                                <li class="breadcrumb-item active">About Slider Images</li>
                            </ol>
                        </div>
                        @section('page_title')
                        about Slider Images
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">About Slider Images</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{ route('about_image_slider.create', ['about_id' => $about_id]) }}">
                                        <button class="btn btn-success btn-sm float-right ml-2">
                                            <i class="fas fa-plus"></i> Add About Slider Images Images
                                        </button>
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!empty($data->about_image))
                                                        <a href="{{ asset('uploads/about_image/' . $data->about_image) }}" target="_blank">
                                                            <img class="avatar-lg" src="{{ asset('uploads/about_image/' . $data->about_image) }}" alt="Project Image">
                                                        </a>
                                                    @else
                                                ...
                                                <td>
                                                    <a href="{{ route('about_image_slider.edit', $data->id) }}" class="btn btn-primary waves-effect waves-light btn-xs">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button data-value="{{ $data->id }}" class="btn btn-danger waves-effect waves-light btn-xs cdelete"><i class="fas fa-trash"></i></button>
                                                    <form id="deleteform{{ $data->id }}" method="post" action="{{ route('about_image_slider.destroy', [$data->id]) }}">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                                    </form>
                                                </td>
