                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('flat.index') }}">Slide</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form id="form" method="post" action="{{ route('flat.slide_update', [$data->id]) }}"
                            ...
                            <div class="row mb-1">
                                ...
                                <input type="hidden" name="flat_id" value="{{$data->flat_id}}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <a href="{{ asset('uploads') }}/flats/{{ $data->thumbnail_image }}" target="_blank"> → view image</a>
                                    </div>
                                </div>
