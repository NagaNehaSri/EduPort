                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('service_benefits.index') }}">Service Benefits</a></li>
                                <li class="breadcrumb-item active">Edit Service Benefits</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Service Benefits
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Service Benefits</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('service_benefits.update', [$data->id]) }}"
