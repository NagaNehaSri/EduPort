                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
                                            @if (!empty($data->image))
                                            <a href="{{ asset('uploads/home_page_services/' . $data->image) }}" target="_blank">
                                                <img class="avatar-lg" src="{{ asset('uploads/home_page_services/' . $data->image) }}" alt="Image">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('home_page_services.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('home_page_services.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
