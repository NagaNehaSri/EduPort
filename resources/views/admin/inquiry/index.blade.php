                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive"
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                        <td>{{ $key + 1 }}</td>
                                            <td>{{ $data->inquiryname }}</td>
                                            <td>{{ $data->inquiryemail }}</td>
                                            <td>{{ $data->inquiryphone }}</td>
                                            <td>{{ $data->inquiryservice }}</td>
                                            <td>{{ $data->inquirycomments }}</td>
                                            ...
                                            <td>
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('admin.dashboard.inquiry.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
