                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form id="form" method="post" action="{{ route('benefit.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="long_description"
                                                   class="form-control ckeditor-desc @error('long_description') is-invalid @enderror" name="long_description">{{ old('long_description') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify @error('image') is-invalid @enderror" name="image" id="image" accept="image/jpg, image/jpeg, image/png, image/svg+xml">
                                            @error('image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
