                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('adblue_solutions.index') }}">Adblue solutions</a></li>
                                <li class="breadcrumb-item active">Add Adblue solutions</li>
                            </ol>
                        </div>
                        @section('page_title')
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Add Adblue Solutions</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('adblue_solutions.store') }}"
