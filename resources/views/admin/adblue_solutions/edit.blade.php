                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">Adblue Solutions</a></li>
                                <li class="breadcrumb-item active">Edit Adblue Solutions</li>
                            </ol>
                        </div>
                        @section('page_title')
                            Adblue Solutions
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form id="form" method="post" action="{{ route('adblue_solutions.update', [$data->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify @error('image') is-invalid @enderror"
                                                ...
                                                data-default-file="{{ asset('uploads/adblue_solutions/' . $data->image) }}">
                                            @error('image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
