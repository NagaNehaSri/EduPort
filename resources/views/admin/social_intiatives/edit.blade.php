                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">Social Intiatives</li>
                            <li class="breadcrumb-item active">Edit Social Intiatives</li>
                        </ol>
                    </div>
                    @section('page_title')
                    Social Intiatives
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form id="form" method="post" action="{{ route('social_intiatives.update', [$data->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="image" class="dropify @error('image') is-invalid @enderror" name="image" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/social_initiatives/' . $data->image) }}" />
                                            @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                            <div class="text-muted mt-1"><kbd>* Image size 380 x 323 pixels</kbd></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label for="heading_2" class="control-label">Heading 2 *</label>
                                            <textarea id="heading_2" class="form-control mini-suneditor @error('heading_2') is-invalid @enderror" name="heading_2">{{ $data->heading_2 }}</textarea>
                                            @error('heading_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="image_2" class="dropify @error('image_2') is-invalid @enderror" name="image_2" accept="image/jpg, image/jpeg, image/png, image/webp, image/gif" data-height="150" data-default-file="{{ asset('uploads/social_intiatives/' . $data->image_2) }}" />
                                            @error('image_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                            <div class="text-muted mt-1"><kbd>* Image size 390 x 389 pixels</kbd></div>
                                        </div>
                                    </div>
