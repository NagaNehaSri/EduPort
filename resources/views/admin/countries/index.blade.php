                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ asset('uploads/country' . $data->country_image) }}" target="_blank">
                                                <img class="avatar-lg" src="{{ asset('uploads/country/' . $data->country_image) }}" alt="Country Image">
                                            </a>
                                            @else
                                            <span class="badge badge-warning">No Country Image</span>
                                            @endif
                                        </td>
                                        ...
                                        <button data-value="{{ $data->id }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('countries.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
