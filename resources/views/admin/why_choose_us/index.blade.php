                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('what_we_do.create') }}">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($data->image != '')
                                            <a href="{{ asset('uploads') }}/what_we_do/{{ $data->image }}"
                                                target="_blank">
                                                <img class="avatar-lg"
                                                    src="{{ asset('uploads') }}/what_we_do/{{ $data->image }}"
                                                    alt="{{ $data->title }}">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('what_we_do.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('what_we_do.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
