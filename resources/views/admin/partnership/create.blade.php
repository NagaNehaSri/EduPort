                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('image_cms.index') }}">Partnership</a></li>
                                <li class="breadcrumb-item active">Add Partnership</li>
                            </ol>
                        </div>
                        @section('page_title')
                            Add Partnership
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Add Partnership</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('partnership.store') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify @error('logo') is-invalid @enderror" name="logo"
                                                   id="logo" accept="image/jpg, image/jpeg, image/png">
                                            @error('logo')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
