                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">Scholarship Faq</li>
                            <li class="breadcrumb-item active">Edit Scholarship Faq</li>
                        </ol>
                    </div>
                    @section('page_title')
                    Scholarship Faq
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-right mb-2">
                            <a href="{{route('faq.index')}}" class="btn btn-dark waves-effect waves-light btn-xs">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Scholarship Faq</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('scholarship_faq.update', [$data->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
