                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('adblue_specifications.index') }}">Adblue Specifications</a></li>
                                <li class="breadcrumb-item active">Add Adblue Specifications</li>
                            </ol>
                        </div>
                        @section('page_title')
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title">Add Adblue Specifications</h4>
                                </div>
                            </div>
                            <hr>
                            <form id="form" method="post" action="{{ route('adblue_specifications.store') }}"
