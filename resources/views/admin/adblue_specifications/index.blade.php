                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Adblue Specifications</li>
                        </ol>
                    </div>
                    @section('page_title')
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>
                                            @if ($data->image != '')
                                            <a href="{{ asset('uploads') }}/studyabroadinfo/{{ $data->image }}"
                                                target="_blank">
                                                <img class="avatar-lg"
                                                    src="{{ asset('uploads') }}/studyabroadinfo/{{ $data->image }}"
                                                    alt="{{ $data->title }}">
                                            </a>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('adblue_specifications.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('adblue_specifications.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
