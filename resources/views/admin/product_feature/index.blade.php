                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-6">
                                <a href="{{ route('product_feature.create') }}">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Product Feature Description</th>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><span class="badge badge-primary">Click to edit, edit, and view</span></td> 
                                          
                                            <td>
                                                @if ($data->feature_image != '')
                                                    <a href="{{ asset('uploads') }}/products/{{ $data->feature_image }}"
                                                        target="_blank">
                                                        <img class="avatar-lg"
                                                            src="{{ asset('uploads') }}/products/{{ $data->feature_image  }}"
                                                            alt="">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('product_feature.edit', [$data->id]) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('product_feature.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form> -->
                                            </td>
