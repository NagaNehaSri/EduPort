                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Home Page Enquiry</li>
                        </ol>
                    </div>
                    @section('page_title')
                    Home Page Enquiry
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Home Page Enquiry</h4>
                            </div>
                            <div class="col-md-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->video_link }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('home_page_enquiry.edit', [$data->id]) }}"
                                                ...
                                                <form id="deleteform{{ $data->id }}" method="post"
                                                    action="{{ route('home_page_enquiry.destroy', [$data->id]) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                </form>
                                            </td>
