                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($data->video != '')
                                            <a href="{{ asset('uploads') }}/video_gallery/{{ $data->video }}"
                                                target="_blank">
                                                <video class="avatar-lg"
                                                    src="{{ asset('uploads') }}/video_gallery/{{ $data->video }}"
                                                    alt="{{ $data->heading }}" controls>
                                        ...
                                        <td>
                                            <a href="{{ route('video_gallery.edit', [$data->id]) }}"
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post"
                                                action="{{ route('video_gallery.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                        </td>
